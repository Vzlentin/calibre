...
@pytest.mark.skip(reason="Pending U5c: kill/resume needs the time-loop and restart path.")
...
@pytest.mark.skip(reason="Pending U16: distribution invariance needs the dispatch substrate.")
...
@pytest.mark.skip(reason="Pending U10: state equality needs serializable calibration state.")
...
@pytest.mark.skip(reason="Pending U5c: byte identity needs a seed-sensitive test adapter.")
