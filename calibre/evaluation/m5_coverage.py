...
from calibre.core.io import read_parquet, write_parquet
...
def write_coverage_artifacts(
    ...
    *,
    ...
    _validate_ledger_columns(ledger, lower_col=lower_col, upper_col=upper_col)
    if ledger.empty:
    ...
    write_parquet(node, coverage_by_node_path)
...
def _validate_ledger_columns(ledger: pd.DataFrame, *, lower_col: str, upper_col: str) -> None:
    required = [UNIQUE_ID, H, MODEL_NAME, Y, lower_col, upper_col]
